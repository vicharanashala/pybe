  ...
  if (showLesson) {
    return (
      <main className="lesson-page">
        <button className="primary" onClick={() => setShowLesson(false)}>Back to PyBe</button>
        <AdderLesson />
      </main>
    );
  }
  ...
  return (
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <button className="primary" onClick={() => setShowLesson(true)}>Try: Story-based lesson (beta)</button>
